<template>
    <div class="pb-16 lg:pb-20">
        <div class="flex items-center pb-6">
            <img src="../../assets/images/icon-project.png" alt="icon story" />
        ...
        <div>
            ...
            <a href=" / " class="mb-6 flex items-center justify-between border border-grey-lighter px-4 py-4 sm:px-6 hover:bg-slate-100">
                ...
                <span class="w-1/10">
                    <img src="../../assets/images/chevron-right.png" class="mx-auto" alt="chevron right" />
                </span>
            </a>
